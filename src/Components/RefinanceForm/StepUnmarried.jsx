...
const StepUnmarried = ({ formData, setFormData, step, setStep }) => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            const data = {
                loan_application_id: formData.loanId, status: formData.martialStatus,
                other_martial_status: formData.otherLegalStatus,
                relationship_status: formData.relationshipStatus, relationship_type: formData.relationshipType
            }
            const res = await axios.post(updateMartialStatus, { data });
                                ...
                                formData.otherLegalStatus === 'Yes' && (
                                    <div className='mt-4 text-start'>
                                        <div className='dropdown'>
                                            ...
                                            <Dropdown options={usaStates} value={formData.relationshipStatus} onChange={(e) => setFormData({...formData, relationshipStatus: e.value})} optionLabel="name" 
